...
bool R_PG_SCI_Set_C2(void)
{
	...
	res = R_SCI_Set(
		2,
		PDL_SCI_PIN_SCI2_RXD2_P52 | PDL_SCI_PIN_SCI2_TXD2_P50
	);
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_ReceiveAllData_C2(uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_ReceiveAllData_C2
*
