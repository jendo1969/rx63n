...
bool R_PG_Timer_Set_MTU_U0_C3(void)
{
	...
	parameters.counter_operation = PDL_MTU2_CLK_PCLK_DIV_16 | PDL_MTU2_CLK_RISING | PDL_MTU2_CLEAR_TGRA;
	parameters.TGR_A_B_operation = PDL_MTU2_A_OC_HIGH | PDL_MTU2_B_OC_LOW;
	parameters.TGR_C_D_operation = PDL_MTU2_C_OC_HIGH | PDL_MTU2_D_OC_LOW;
	parameters.TGRA_TCNTV_value = 59999;
	parameters.TGRB_TCNTW_value = 0;
	parameters.TGRC_TGRU_value = 59999;
	parameters.TGRD_TGRV_value = 0;
	parameters.func1 = Mtu3IcCmAIntFunc;
	parameters.func2 = Mtu3IcCmBIntFunc;
	parameters.func3 = Mtu3IcCmCIntFunc;
	parameters.func4 = Mtu3IcCmDIntFunc;
	parameters.interrupt_priority_1 = 15;
	parameters.func7 = Mtu3OvIntFunc;
	parameters.interrupt_priority_3 = 15;
